...
SHELL	= /bin/bash
CC      = gcc
INCLUDE = -Iinclude -I/media/hdd/tmp/b/include
CFLAGS  = -march=armv7-a -mtune=cortex-a7 -mfpu=neon-vfpv4 -ffast-math -Ofast -g -O3 -DUSING_GENERATED_CONFIG_H
EXTRA_CFLAGS = -Iinclude -I/media/hdd/tmp/b/include  -fvisibility=hidden  -D_REENTRANT    -I/usr/include/dbus-1.0 -I/usr/lib/arm-linux-gnueabihf/dbus-1.0/include   -D_REENTRANT -DHAVE_LINUX_VERSION_H -Wall
LDFLAGS = 
EXTRA_LDFLAGS =  -Wl,--no-undefined -lm -ldl -lts -lpthread -lrt
